        ...
        <table class="table align-middle mb-0">
          ...
          <tbody>
            @forelse ($items as $index => $it)
              @php
                $stt = (method_exists($items,'firstItem') && !is_null($items->firstItem()))
              ...
              <tr>
                ...
                <td class="text-end">
                  <div class="btn-group btn-group-sm">
                    <a href="{{ route('admin.meal_types.show', $it->id) }}" class="btn btn-outline-secondary" title="Xem">
                      <i class="bi bi-eye"></i>
                    </a>
                    <a href="{{ route('admin.meal_types.edit', $it->id) }}" class="btn btn-outline-info" title="Sửa">
