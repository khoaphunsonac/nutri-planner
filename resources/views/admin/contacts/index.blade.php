...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="d-flex align-items-center">
            ...
            <small class="text-muted ms-2">
                ...
                <a href="{{ route('contact.index') }}" class="text-decoration-none">Click vào dòng để xem chi tiết</a>
            </small>
        </div>
    </div>
    ...
    <td>
        ...
        <a href="{{ route('contact.delete', $item->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Xác nhận xoá?')">
